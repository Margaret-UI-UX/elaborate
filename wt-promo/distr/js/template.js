...
; /* Start:"a:4:{s:4:"full";s:39:"/js/owl.carousel.min.js?159196673649995";s:6:"source";s:23:"/js/owl.carousel.min.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
/**
 * Owl Carousel v2.3.4
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:38:"/js/jquery.validate.js?159558153851043";s:6:"source";s:22:"/js/jquery.validate.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
/*!
...
$.extend( $.validator, {
	...
	messages: {
		...
		maxlength: $.validator.format( "Пожалуйста введите больше {0} символов." ),
		minlength: $.validator.format( "Пожалуйста введите больше {0} символов." ),
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:29:"/js/scripts.js?15961855415823";s:6:"source";s:14:"/js/scripts.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
$(function(){
	...
	let tab = function () {
		let tabNav = document.querySelectorAll('.vacansy__nav-item'),
			...
			tabName, startVacancy;
			
		
		startVacancy = $('.vacansy__nav-item.current').attr('data-vacancy-name');
		startVacancyId = $('.vacansy__nav-item.current').attr('data-vacancy-id');
		if(startVacancy){
			$('.career__form-vacansy').html(startVacancy);
		}
		
		if(startVacancy){		
			$('input#vacancy_id').val(startVacancyId);
			$('input#mobile_vacancy_id').val(startVacancyId);
		}
		...
		function selectTabNav() {
			...
			$('.career__form-vacansy').html(this.getAttribute('data-vacancy-name'));
			$('input#vacancy_id').val(this.getAttribute('data-vacancy-id'));
			$('input#mobile_vacancy_id').val(this.getAttribute('data-vacancy-id'));
		}
...
/* End */
;; /* /js/owl.carousel.min.js?159196673649995*/
; /* /js/jquery.validate.js?159558153851043*/
; /* /js/scripts.js?15961855415823*/
